...
import { addSearchDate, addSearchResult, removeSearchDate } from '../reducers/users';
...
export default function RechercheScreen1({ navigation }) {
  ...
  // Pour effacer les dates de recherche lorsqu'on revient sur la page
  useEffect(() => {
  ...
  //état pour récupérer dates de début DateTimePicker (initialisé pour récupérer une nouvelle date)
  ...
  const handleResearch = () => {
    ...
    // appelle la route pour afficher les resultats de recherche
